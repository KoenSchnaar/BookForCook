    ...
    public partial class KookboekContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<GerechtIngrediënt>(entity =>
            {
                ...
                entity.HasOne(d => d.Gerecht)
                    .WithMany(p => p.GerechtIngrediënts)
                    .HasForeignKey(d => d.GerechtId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__GerechtIn__Gerec__5CD6CB2B");

                entity.HasOne(d => d.Ingrediënt)
                    .WithMany(p => p.GerechtIngrediënts)
                    .HasForeignKey(d => d.IngrediëntId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__GerechtIn__Ingre__5EBF139D");
            });
            ...
            modelBuilder.Entity<Gerechten>(entity =>
            {
                ...
                entity.Property(e => e.Bereidingswijze)
                    .IsRequired()
                    .HasMaxLength(3000)
                    .IsUnicode(false);
